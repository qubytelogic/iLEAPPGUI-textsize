#Original by Alexis Brignoni | @AlexisBrignoni | abrignoni.com
#*************************************************************
#2019-12-30 Updated by Shafik G. Punja 
#for pseudo visually impaired examiners (PVIE) 
#adding font size and font type and changed size of output window
#comments added after each statement to indicate addition of type and font size
#*************************************************************
